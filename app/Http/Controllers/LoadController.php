...
class LoadController extends Controller
{
    ...
    public function store(Request $request, LogsController $logsController)
    {
        $validator = Validator::make($request->all(), [
            ...
            'pickup_location_address' => ['required', 'array', 'min:1'],
            'pickup_location_address.*' => ['required', 'string', 'max:500'],
        ...
        // Custom validation: ensure dates are valid
        ...
        try {
            ...
            for ($i = 0; $i < $rowCount; $i++) {
                ...
                $loadLeg->pickup_location_id = $pickupLocation->id;
                $loadLeg->delivery_location_id = $deliveryLocation->id;
