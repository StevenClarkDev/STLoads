(function($) {
    ...
    $("#basicScenario").jsGrid({
        ...
        pageSize: 5,
        pageButtonCount: 5,
        deleteConfirm: "Do you really want to delete this load?",
        controller: db,
        fields: [
            { name: "ID", type: "text", width: 100 },
            { name: "Pickup Location", type: "text", width: 250 },
            { name: "Delivery Location", type: "text", width: 250 },
            { name: "Pickup Date", type: "text", width: 150 },
            { name: "Delivery Date", type: "text", width: 150 },
            { name: "Bid Status", type: "html", width: 150 },
