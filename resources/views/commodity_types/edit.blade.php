   ...
   <div class="col-xl-12 box-col-6 p-3">
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <h5 class="mb-3">Commodity Type Edit</h5>
                    <form class="card-body" method="POST" action="{{ route('commodity_types.update', $commodity_type->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" id="multicol-username" class="form-control" placeholder="Enter Name"
                                        name="name" value="{{ $commodity_type->name }}" />
