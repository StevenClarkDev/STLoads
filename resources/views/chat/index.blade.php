        ...
        <div class="row g-0">
                            ...
                            <div class="tab-pane fade show active" id="chats" role="tabpanel" aria-labelledby="chats-tab">
                                ...
                                <ul class="chats-user">
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/avtar/3.jpg" alt="user">
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/avtar/11.jpg" alt="user">
                                                <div class="status bg-success"></div>
                                            </div>
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/avtar/7.jpg" alt="user">
                                                <div class="status bg-success"></div>
                                            </div>
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/avtar/16.jpg" alt="user">
                                                <div class="status bg-success"></div>
                                            </div>
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/avtar/4.jpg" alt="user">
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/blog/comment.jpg" alt="user">
                                                <div class="status bg-warning"></div>
                                            </div>
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/blog/4.jpg" alt="user">
                                                <div class="status bg-success"></div>
                                            </div>
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/blog/12.png" alt="user">
                                                <div class="status bg-warning"></div>
                                            </div>
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/blog/9.jpg" alt="user">
                                                <div class="status bg-warning"></div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                ...
                                <div class="contact-wrapper">
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/blog/14.png" alt="user">
                                    ...
                                    <ul class="border-0">
                                        ...
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/user/6.jpg" alt="user">
                                                <div> <span>Darrell Steward</span>
                                                    <p>200-300-1030</p>
                                                </div>
                                            </div>
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/user/1.jpg" alt="user">
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="../assets/images/user/2.jpg" alt="user">
            ...
            <div class="col-xxl-9 col-xl-8 col-md-7 box-col-7">
                <div class="card right-sidebar-chat">
                    ...
                    <div class="right-sidebar-Chats" style="background: url('{{ asset('assets/images/texture.png') }}') repeat; background-size: cover;">
                        <div class="msger">
