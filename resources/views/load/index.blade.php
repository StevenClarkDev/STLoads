        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Loads List</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between my-3 mx-4 flex-wrap">
                        ...
                        <div class="d-flex flex-column align-items-end gap-2 mt-2 mt-md-0">
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-outline-primary px-3" type="button" id="filterDropdown"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-3" style="min-width: 250px;"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control form-control-sm mb-2" placeholder="From">
                                            ...
                                            @foreach(range(1, 8) as $i)
                                                <tr
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- Status Modal -->
                                                        <div class="modal fade" id="statusModal-{{ $i }}" tabindex="-1"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content p-4">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        @if($status == 'accepted')
                                                                            <p class="text-muted mb-4">Congratulations! Your bid has
                                                                                been accepted by the client.</p>
                                                                        @elseif($status == 'rejected')
                                                                            <p class="text-muted mb-4">Client has rejected your bid
                                                                                due to high pricing or other concerns.</p>
                                                                        @else
                                                                            <p class="text-muted mb-4">Please review the client's
                                                                                offer and submit your bid below.</p>
                                                                        @endif
                                                                        ...
                                                                        @if($status == 'accepted')
                                                                            <div class="row mb-3">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <label class="form-label">Accepted On</label>
                                                                                    <input type="text" class="form-control"
