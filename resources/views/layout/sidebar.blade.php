                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="{{ route('user_approval') }}">
                                                            <div
                                                                class="btn btn-{{ $currentRoute == 'user_approval' ? 'primary' : 'light' }}">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('users_by_role', 3) }}">
                                                            <div
                                                                class="btn btn-{{ ($currentRoute == 'users_by_role' && request()->route('id') == 3) ? 'primary' : 'light' }}">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('users_by_role', 2) }}">
                                                            <div
                                                                class="btn btn-{{ ($currentRoute == 'users_by_role' && request()->route('id') == 2) ? 'primary' : 'light' }}">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('users_by_role', 4) }}">
                                                            <div
                                                                class="btn btn-{{ ($currentRoute == 'users_by_role' && request()->route('id') == 4) ? 'primary' : 'light' }}">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('users_by_role', 5) }}">
                                                            <div
                                                                class="btn btn-{{ ($currentRoute == 'users_by_role' && request()->route('id') == 5) ? 'primary' : 'light' }}">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="btn btn-outline-primary"><i
                                                                data-feather="database"></i>Storage
                                                        </div>
                                                        <div class="m-t-15">
