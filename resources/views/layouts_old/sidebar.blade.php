<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper"><a href="{{ route('manage-loads')}}"><img class="img-fluid for-light"
        ...
        <div class="logo-icon-wrapper"><a href="{{ route('manage-loads')}}"><img class="img-fluid"
                    src="{{ url('assets/images/logo/logo-icon.png') }}" alt=""></a></div>
        <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    <li class="back-btn"><a href="{{ route('manage-loads')}}"><img class="img-fluid"
