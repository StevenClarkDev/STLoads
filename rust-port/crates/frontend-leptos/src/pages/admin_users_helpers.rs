...
use crate::{api, document_upload};
use shared::{
    AdminUpdateUserProfileRequest, AdminUpdateUserRequest, AdminUserDirectoryUser,
...
pub(super) fn admin_status_tone(status_key: &str) -> &'static str {
    match status_key {
        "approved" => "success",
...
pub(super) fn admin_profile_next_step(status_key: &str) -> &'static str {
    match status_key {
        "pending_otp" => {
...
pub(super) fn admin_user_card_attention(user: &AdminUserDirectoryUser) -> Option<String> {
...
pub(super) fn admin_account_action_plan(
    role_key: &str,
    status_key: &str,
...
pub(super) fn admin_profile_action_plan(
    role_key: &str,
    status_key: &str,
...
pub(super) fn profile_has_fact(facts: &[shared::AdminUserProfileFact], label: &str) -> bool {
    facts.iter().any(|fact| fact.label == label)
}

pub(super) fn admin_profile_readiness_items(
    role_key: &str,
    status_key: &str,
...
pub(super) fn user_matches_query(user: &AdminUserDirectoryUser, query: &str) -> bool {
...
pub(super) fn run_directory_review_action(
    user_id: u64,
    decision: &'static str,
