                    ...
                    <article style="display:grid;gap:1.25rem;">
                        ...
                        <section style="display:grid;grid-template-columns:minmax(320px,420px);gap:1rem;align-items:start;">
                            <div style="border:1px solid #e5e7eb;border-radius:1rem;padding:1rem;background:#fcfcfb;display:grid;gap:0.75rem;">
                                ...
                                <label style="display:grid;gap:0.35rem;"><span>"Amount (cents)"</span><input prop:value=move || amount_cents.get() on:input=move |ev| amount_cents.set(event_target_value(&ev)) placeholder="Amount in cents" style="padding:0.75rem 0.9rem;border:1px solid #d1d5db;border-radius:0.85rem;" /></label>
                                <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.75rem;">
                                    <label style="display:grid;gap:0.35rem;"><span>"Platform fee"</span><input prop:value=move || platform_fee_cents.get() on:input=move |ev| platform_fee_cents.set(event_target_value(&ev)) placeholder="Fee in cents" style="padding:0.75rem 0.9rem;border:1px solid #d1d5db;border-radius:0.85rem;" /></label>
                                ...
                                <label style="display:grid;gap:0.35rem;"><span>"Accessorial type"</span><input prop:value=move || accessorial_type.get() on:input=move |ev| accessorial_type.set(event_target_value(&ev)) placeholder="Accessorial category" style="padding:0.75rem 0.9rem;border:1px solid #d1d5db;border-radius:0.85rem;" /></label>
                                <label style="display:grid;gap:0.35rem;"><span>"Dispute type"</span><input prop:value=move || dispute_type.get() on:input=move |ev| dispute_type.set(event_target_value(&ev)) placeholder="Dispute category" style="padding:0.75rem 0.9rem;border:1px solid #d1d5db;border-radius:0.85rem;" /></label>
                                <div style="display:flex;gap:0.6rem;flex-wrap:wrap;">
                                ...
                                <label style="display:grid;gap:0.35rem;"><span>"KYC status"</span><input prop:value=move || kyc_status.get() on:input=move |ev| kyc_status.set(event_target_value(&ev)) placeholder="Stripe account KYC status" style="padding:0.75rem 0.9rem;border:1px solid #d1d5db;border-radius:0.85rem;" /></label>
